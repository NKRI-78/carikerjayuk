...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="<?= base_url('public/assets/image/logo.png') ?>?t=" . time()" />
    ...
    <!-- add custome css -->
    <link href="<?= base_url("public/assets/css/custom.css") ?>?t=". time() rel="stylesheet" type="text/css" />
...
<body class="flex flex-col" style="background-color: #FBB94D;">

    <nav class="flex justify-end items-center mr-60">
        ...
        <!-- NAVIGATION -->
        <div class="hidden lg:block navbar-c rounded-md py-4 my-4">
            <div class="container-menu">
                <div class="box menu-box">
                    <a href="<?= base_url() ?>" class="text <?=$uri->getSegment(1) === '' ? ' font-bold text-white' : 'text-white ' ?>">Home</a>
                </div>
                <div class="box menu-box">
                    <a href="<?= base_url() ?>/term-and-condition" class="text <?=$uri->getSegment(1) === 'term-and-condition' ? ' font-bold text-white' : 'text-white' ?>">Term & Condition</a>
                </div>
                <div class="box menu-box">
                    <a href="<?= base_url() ?>/about-us" class="text <?=$uri->getSegment(1) === 'about-us' ? ' font-bold text-white' : 'text-white' ?>">About Us</a>
                </div>
            </div>
        ...
        <div class="lg:hidden navbar-c rounded-md my-4 py-4 mr-12">
